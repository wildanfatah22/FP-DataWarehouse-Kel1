<?php include 'koneksi.php';
    ...
    from factpurchasing fp join dimproduct pd on pd.ProductID = fp.ProductID 
                                    ...
                                    <div class="card-body">
                                        <div class="row no-gutters align-items-center">
                                            <div class="col mr-2">
                                                ...
                                                <div class="h5 mb-0 font-weight-bold text-gray-800">
                                                    <?php                                           
                                                    $sql = "SELECT SUM(OrderQty) as jumlah_trbl from factpurchasing";
                                                    $query = mysqli_query($conn, $sql);
                                                    if (mysqli_num_rows($query) > 0){
                                                        while($row2=mysqli_fetch_array($query)){
...
Highcharts.chart('chart1', {
    ...
    xAxis: {
        categories : [
            <?php 
                $sql = "SELECT SUM(fp.OrderQty) as Jumlah, dt.Year AS Tahun from factpurchasing fp
