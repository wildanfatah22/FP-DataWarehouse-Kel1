<?php include 'koneksi.php';
    ...
    $sql = "SELECT coalesce (pd.ProductCategory, 'Tidak Memiliki Kategori') AS ProductCategory, SUM(fs.OrderQty) AS OrderQuantity from factsales fs join dimproduct pd on pd.ProductID = fs.ProductID group by pd.ProductCategory";
    ...
    pd.ProductName as Name, SUM(fs.OrderQty) AS OrderQuantity from factsales fs join dimproduct pd on pd.ProductID = fs.ProductID group by ProductCategory, Name";
                                        ...
                                        <div class="row no-gutters align-items-center">
                                            <div class="col mr-2">
                                                ...
                                                <div class="h5 mb-0 font-weight-bold text-gray-800">
                                                    <?php                                           
                                                    $sql = "SELECT COUNT(ProductID) as jumlah_prd from dimproduct";
                                    ...
                                    <div class="card-body">
                                        <div class="row no-gutters align-items-center">
                                            <div class="col mr-2">
                                                ...
                                                <div class="h5 mb-0 font-weight-bold text-gray-800">
                                                    <?php                                           
                                                    $sql = "SELECT SUM(OrderQty) as jumlah_trjl from factsales";
                                                    $query = mysqli_query($conn, $sql);
                                                    if (mysqli_num_rows($query) > 0){
                                                        while($row2=mysqli_fetch_array($query)){
                                    ...
                                    <div class="card-body">
                                        <div class="row no-gutters align-items-center">
                                            <div class="col mr-2">
                                                ...
                                                <div class="h5 mb-0 font-weight-bold text-gray-800">
                                                    <?php                                           
                                                    $sql = "SELECT COUNT(ProductCategory) as jumlah_prd from dimproduct";
                                                    $query = mysqli_query($conn, $sql);
                                                    if (mysqli_num_rows($query) > 0){
                                                        while($row2=mysqli_fetch_array($query)){
                                                            echo number_format($row2['jumlah_prd'],0,".",",");
                                    ...
                                    <div class="card-body">
                                        <div class="row no-gutters align-items-center">
                                            <div class="col mr-2">
                                                ...
                                                <div class="h5 mb-0 font-weight-bold text-gray-800">
                                                    <?php                                           
                                                    $sql = "SELECT COUNT(ProductSubCategory) as jumlah_prd from dimproduct";
                                                    $query = mysqli_query($conn, $sql);
                                                    if (mysqli_num_rows($query) > 0){
                                                        while($row2=mysqli_fetch_array($query)){
                                                            echo number_format($row2['jumlah_prd'],0,".",",");
...
Highcharts.chart('chart1', {
    ...
    xAxis: {
        categories : [
            <?php 
                $sql = "SELECT SUM(fs.OrderQty) as Jumlah_terjual, dt.Year AS Tahun from factsales fs join dimtime dt on dt.TimeID = fs.TimeID group by year";
                $query = mysqli_query($conn, $sql);
                if (mysqli_num_rows($query) > 0){
                    while($row2=mysqli_fetch_array($query)){
                        $th=$row2["Tahun"];
