<?php include 'koneksi.php';
    ...
    $tot_amount = mysqli_fetch_row($tot);
            ...
            $sql = "SELECT concat('name:',dv.CreditRating) AS name, concat('y:',COUNT(dv.VendorID)) AS y , concat('drilldown:',dv.CreditRating) as drilldown 
            from dimvendor dv
            group by name";
    ...
    $sql = "SELECT dv.CreditRating AS rating, COUNT(dv.VendorID) AS vendor
    from dimvendor dv
    group by rating";
    ...
    $sql = "SELECT dv.CreditRating AS rating, 
    dv.VendorAccName as Name, COUNT(dv.VendorID) as QTY
    from dimvendor dv
                                    ...
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-success text-uppercase mb-1">
                                                Jumlah Vendor Credit Rating Superior
                                            </div>
                                            <div class="h5 mb-0 font-weight-bold text-gray-800">
                                                <?php                                           
                                                $sql = "SELECT COUNT(VendorID) as emp from dimvendor
                                    ...
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-warning text-uppercase mb-1">
                                                Jumlah Vendor Credit Rating Excellent
                                            </div>
                                            <div class="h5 mb-0 font-weight-bold text-gray-800">
                                                <?php                                           
                                                $sql = "SELECT COUNT(VendorID) as emp from dimvendor
                                    ...
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-danger text-uppercase mb-1">
                                                Jumlah Vendor Credit Rating Above Average
                                            </div>
                                            <div class="h5 mb-0 font-weight-bold text-gray-800">
                                                <?php                                           
                                                $sql = "SELECT COUNT(VendorID) as emp from dimvendor
                                    ...
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-info text-uppercase mb-1">
                                                Jumlah Vendor Credit Rating Average
                                            </div>
                                            <div class="h5 mb-0 font-weight-bold text-gray-800">
                                                <?php                                           
                                                $sql = "SELECT COUNT(VendorID) as emp from dimvendor
                                    ...
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-dark text-uppercase mb-1">
                                                Jumlah Vendor Credit Rating Below Average
                                            </div>
                                            <div class="h5 mb-0 font-weight-bold text-gray-800">
                                                <?php                                           
                                                $sql = "SELECT COUNT(VendorID) as emp from dimvendor
...
Highcharts.chart('chart1', {
    ...
    title: {
        text: 'Kategori Credit Rating Vendor'
    },
    subtitle: {
